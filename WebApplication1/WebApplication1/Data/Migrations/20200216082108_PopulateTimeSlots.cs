...
{
    public partial class PopulateTimeSlots : Migration
    {
        ...
        {
            migrationBuilder.Sql("DELETE FROM TimeSlots"); // must include delete in down method for downgrading migrations to the previous versions
        }
    }
}
